...
informacion que se desea obtener. El diseno de un sistema que a partir de unos valores dados, proporcione unos resultados.
...
A continuacion habra que realizar una serie de procesos como son  la extraccion, transformacion y 
...
este acostumbrado. Por ejemplo, es mas factible que el usuario se sienta mas atraido a acceder a los datos si no requiere
