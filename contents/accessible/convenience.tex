...
In addition, this automation allows the user to visualize the pollution in the city of Malaga in real time, and see specifically the location where it is 
occurring. \\
...
We use SSL that guarantees the encryption of data through the network, as more and more browsers try to protect users by only showing pages that use a secure method.
...
perform downloads or installations. Today, almost everyone is familiar with web browsing, but we do not want to deter people from using our site by requiring them to sign in or install extra software. 
